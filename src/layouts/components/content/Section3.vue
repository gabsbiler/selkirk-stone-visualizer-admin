...
const updateBanner = async (id, count) => {
  ...
  if (!id) {
    try {
      ...
      const response = await axios.patch(`https://api.selkirkstone.app/api/contents/section3/${data.value.id}/add_banner_photo/`, {
        photo: banner_,
      })
    ...
    try {
      ...
      const response = await axios.patch(`https://api.selkirkstone.app/api/contents/section3/${data.value.id}/update_banner_photo/`, {
        banner_photo_id: id,
        photo: banner_,
      })
...
const deleteBanner = async id => {
  ...
  console.log(id)
  try {
    const response = await axios.delete(`https://api.selkirkstone.app/api/contents/section3/${data.value.id}/delete_banner_photo/`, {
      headers: {
